...
function BB(){window.frameElement&&(document.getElementById("b").style.display="none",document.documentElement.style.setProperty("--h","10.00vh"))}
...
<form action="/settings/sound"><button type="submit">Sound</button></form>
</body></html>)=====";
...
Gain: <input name="GN" type="number" min="0" max="255" required><br>Enable: 
<input type="checkbox" name="SE"><br>Sample-rate: <select name="SR"><option 
value="0" selected="selected">44100 Hz</option><option value="1">22050 Hz
</option><option value="2">11025 Hz</option><option value="3">8000 Hz</option>
<option value="4">5512 Hz</option><option value="5">1000 Hz</option></select>
<br>Frequency bands: <select name="SF"><option value="0" selected="selected">16
</option><option value="1">32</option><option value="2">64</option><option 
value="3">128</option><option value="4">256</option><option value="5">512
</option></select><br><button type="button" onclick="B()">Back</button><button 
